...
import com.xk.ui.swt.core.utils.*;
...
import com.xk.core.bean.MemberStruct;
import com.xk.core.bean.ImageNode.TYPE;
import com.xk.ui.swt.chatlogs.ChatLog;
import com.xk.ui.swt.chatlogs.ChatLogCache;
import com.xk.ui.swt.hook.HotKeyListener;
import com.xk.ui.swt.hook.HotKeys;
import com.xk.ui.swt.items.ConvItem;
import com.xk.ui.swt.main.CutScreen;
import com.xk.ui.swt.common.uiLib.MyList;
import com.xk.ui.swt.common.uiLib.XLabel;
import com.xk.ui.swt.common.uiLib.listeners.ItemEvent;
import com.xk.ui.swt.common.uiLib.listeners.ItemListener;
				...
				if(convId.startsWith("@@")) {
					...
					for(MemberStruct ms : struct.MemberList) {
						if(log.fromId.equals(ms.UserName)) {
							...
							ImageNode node = ImageCache
                                    .getUserHeadCache(log.fromId, String.format(Constant.GET_MEMBER_ICON, Constant.HOST), params);
							if(null != node) {
								head = node.getImg();
							}
							break;
