...
import com.xk.core.utils.HttpClientUtils;
...
public class NetEasySource implements IDownloadSource {
    ...
    public List<XRCLine> parse(String content) {
        ...
        if (null != result && null != result.get("klyric")) {
            ...
            if (null != krc) {
                ...
                return KrcText.fromReader(reader, "\\([0-9]*,[0-9]*\\)(\\w+'*\\w*\\s*|[\u4E00-\u9FA5]{1})", "(", ")", 2,
                        true);
            }
        }
    ...
    public List<SearchInfo> getLrc(String name) {
        List<SearchInfo> info = new ArrayList<SearchInfo>();
    ...
    public List<SearchInfo> getMV(String name) {
        List<SearchInfo> rst = new ArrayList<SearchInfo>();
                            ...
                            public String getUrl() {
                                ...
                                if (null != result) {
                                    ...
                                    if (null != urls && !urls.isEmpty()) {
                                        ...
                                        lrcUrl = "http://music.163.com/api/song/lyric?os=osx&id=" + id
                                                + "&lv=-1&kv=-1&tv=-1";
                                        return url;
                                    }
                                }
